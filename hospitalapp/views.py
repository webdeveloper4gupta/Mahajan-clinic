...
def patients(request):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            pat = patient(name=n1, email=n2, phno=n3, Disease=n4,
                          Description=n5, password=n6)
            pat.save()

        # here i set email

            subject = "Welcome to mahajan clinic"
            message = "hello"+pat.name+"I hope you are doing well " + " " + \
                "Your request for appoint mnet with {{n4}} specialist has been setup." + \
                " "+"please visit in time"+" "+"Thank you"
...
def remove_cand(request, cand_id=0):
    if cand_id:
        try:
            ...
            message = "hello"+cand_to_be_removed.name+" I Hope you are doing well"+" " + \
                "As your request your appointment has been cancelled " + " "+"Thank you"
            from_email = settings.EMAIL_HOST_USER
